...
(function () {
    ...
    <div class="toolbar" style="position:fixed;top:0;left:0;right:0;padding:8px;background:#36393f;box-shadow: 0 1px 0 rgba(0,0,0,.2), 0 1.5px 0 rgba(0,0,0,.05), 0 2px 0 rgba(0,0,0,.05);">
        <div style="display:flex;flex-wrap:wrap;">
            <span>Authorization <a href="https://github.com/D3sktool/deleteDiscordMessages/blob/master/help/authToken.md" title="Help">?</a><button id="getToken">auto</button><br>
                <input type="password" id="authToken" placeholder="Auth Token" autofocus>*<br>
                <span>Author <a href="https://github.com/D3sktool/deleteDiscordMessages/blob/master/help/authorId.md" title="Help">?</a> <button id="getAuthor">auto</button></span>
            ...
            <span>Search messages <a href="https://github.com/D3sktool/deleteDiscordMessages/blob/master/help/filters.md" title="Help">?</a><br>
    ...
    <pre style="margin-top:200px;font-size:0.75rem;font-family:Consolas,Liberation Mono,Menlo,Courier,monospace;">
        <center>Star this project on <a href="https://github.com/D3sktool/deleteDiscordMessages" target="_blank">github.com/D3sktool/deleteDiscordMessages</a>!\n\n
